...
def _hparams(algorithm, dataset, random_seed):
    ...
    if algorithm in ['DANN', 'CDANN']:
    ...
    elif algorithm == "IRM_GNN":
        _hparam('irm_lambda', 1e2, lambda r: 10**r.uniform(-1, 5))
        _hparam('irm_penalty_anneal_iters', 5,
                lambda r: int(10**r.uniform(0, 4)))
    elif algorithm == "IRM_GNN_LR":
        _hparam('irm_lambda', 1e2, lambda r: 10**r.uniform(-1, 5))
        _hparam('irm_penalty_anneal_iters', 5,
                lambda r: int(10**r.uniform(0, 4)))
    ...
    elif algorithm == "GroupDRO_GNN":
        _hparam('groupdro_eta', 1e-2, lambda r: 10**r.uniform(-3, -1))
    elif algorithm == "GroupDRO_GNN_LR":
        _hparam('groupdro_eta', 1e-2, lambda r: 10**r.uniform(-3, -1))
        ...
        _hparam('vrex_penalty_anneal_iters', 500,
                lambda r: int(10**r.uniform(0, 4)))
    elif algorithm == "VREx_GNN":
        _hparam('vrex_lambda', 1e1, lambda r: 10**r.uniform(-1, 5))
        _hparam('vrex_penalty_anneal_iters', 5,
                lambda r: int(10**r.uniform(0, 4)))
    elif algorithm == "VREx_GNN_LR":
        _hparam('vrex_lambda', 1e1, lambda r: 10**r.uniform(-1, 5))
        _hparam('vrex_penalty_anneal_iters', 5,
                lambda r: int(10**r.uniform(0, 4)))
    elif algorithm == "SD":
