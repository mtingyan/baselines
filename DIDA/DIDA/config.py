...
parser.add_argument('--nhid', type=int, default=16, help='dim of hidden embedding') # 8
parser.add_argument('--output_dim', type=int, default=40, help='num of classes') # 8
parser.add_argument('--n_layers',type=int,default=2)
parser.add_argument('--heads', type=int, default=2, help='attention heads.') # 4
...
parser.add_argument('--la_intervene',type=float,default=0.005) 
